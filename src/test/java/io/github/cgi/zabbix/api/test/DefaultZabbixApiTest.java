...
public class DefaultZabbixApiTest {
    ...
    @Test
    public void testGetHistorySorted() {
        boolean login = zabbixApi.login(user_login, user_password);
        System.err.println("login:" + login);
        String metricId = params.getProperty("testGetHistorySorted.metricId", "664120");
        String timestamp = params.getProperty("testGetHistorySorted.timestamp", "-1");

        Request request = RequestBuilder.newBuilder()
                .method("history.get")
                .paramEntry("output", "extend")
//                .paramEntry("output", Arrays.asList("clock", "value", "ns"))
                .paramEntry("history", 3)
                .paramEntry("limit", 10)
                .paramEntry("itemids", Arrays.asList(metricId))
    ...
    public void testGetHostItems() {
        boolean login = zabbixApi.login(user_login, user_password);
        System.err.println("login:" + login);
        String hostId = params.getProperty("testGetHostItems.hostId", "11429");
//        String timestamp = params.getProperty("testGetHostItems.timestamp", "0");
...
//                .paramEntry("history", 3)
                ...
                .paramEntry("hostids", Arrays.asList(hostId))
